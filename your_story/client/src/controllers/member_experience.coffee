angular.module 'aiesec'
  .controller 'MemberExperienceController', ($scope, currentCreation, mpTypes) ->
    $scope.memberTypes = {}
    ...
    if currentCreation.memberShipExperienceFormValues
      $scope.memberShipExperienceFormValues = currentCreation.memberShipExperienceFormValues
    else
      $scope.memberShipExperienceFormValues = currentCreation.memberShipExperienceFormValues = {}
